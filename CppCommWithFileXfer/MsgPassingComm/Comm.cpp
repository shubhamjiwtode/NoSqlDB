...
namespace MsgPassingCommunication
{
  Context::Context()
  {
    saveFilePath = "../ServerPrototype/SaveFiles";  // default staging area for incoming files
    sendFilePath = "../ServerPrototype/SendFiles";  // default staging area for outgoing files
  }
  Context ctx;
